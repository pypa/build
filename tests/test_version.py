...
def test_normalize():
    ...
    assert VersionChecker.normalize_version('1.0dev3') == '1.0.dev3'
    assert VersionChecker.normalize_version('1.0dev') == '1.0.dev0'
    assert VersionChecker.normalize_version('1.0003dev') == '1.3.dev0'
    assert VersionChecker.normalize_version('1.000123dev') == '1.123.dev0'
    assert VersionChecker.normalize_version('1.0.dev0') == '1.0.dev0'
    assert VersionChecker.normalize_version('1.0.dev') == '1.0.dev0'
    assert VersionChecker.normalize_version('1.0-dev') == '1.0.dev0'
    assert VersionChecker.normalize_version('1.0_dev') == '1.0.dev0'
